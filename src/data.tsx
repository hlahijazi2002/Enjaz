...
export const reasons = [
  {
    ...
    desc: "نحن نقدر قيمة الوقت، لذا نلتزم بتسليم مشاريعنا في مواعيدها المحددة دون المساس بالجودة.",
    icon: <Zap className="w-10 h-10 text-blue-400" />,
  },
  {
    title: "أمان وموثوقية عالية",
    desc: "نطبق أعلى معايير الأمان البرمجي لحماية بياناتك وبيانات عملائك من أي ثغرات محتملة.",
    icon: <ShieldCheck className="w-10 h-10 text-blue-400" />,
  },
  {
    title: "دعم فني متكامل",
    desc: "فريقنا متواجد دائماً لمساندتك تقنياً حتى بعد إطلاق المشروع، لضمان استمرارية نجاحك.",
    icon: <HeartHandshake className="w-10 h-10 text-blue-400" />,
  },
  {
    title: "حلول تقنية عالمية",
    desc: "نستخدم أحدث التقنيات البرمجية التي تضمن لمشروعك التوسع والنمو المستقبلي بسهولة.",
