...
export default function Hero() {
  return (
    <section className="relative min-h-screen pt-32 pb-20 flex items-center justify-center overflow-hidden px-6">
      <div className="absolute top-[-10%] right-[-10%] w-[500px] h-[500px] bg-blue-600/20 blur-[150px] rounded-full -z-10 animate-pulse" />
      <div className="absolute bottom-[-10%] left-[-10%] w-[400px] h-[400px] bg-purple-600/10 blur-[130px] rounded-full -z-10" />
        ...
        <div className="text-right flex flex-col items-end">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-black tracking-tight leading-[1.1] text-white">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-l from-blue-400 via-blue-500 to-purple-500">
                الرقمي بذكاء
              </span>
            </h1>
